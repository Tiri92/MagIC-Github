...
public class FakeApiService implements ApiService {
    ...
    public void generateRandomUser() {
        // TODO: A modifier
        int randomIndex = (int) (Math.random() * FakeApiServiceGenerator.FAKE_USERS_RANDOM.size());
        User randomUser = FakeApiServiceGenerator.FAKE_USERS_RANDOM.get(randomIndex);
